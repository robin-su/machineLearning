...
if __name__ == "__main__":
    ...
    c2 = 10
    N = c1 + c2
    x_c1 = 3*np.random.randn(c1, 2) # c1行，2列的高斯分布的样本
    ...
    clfs = [svm.SVC(C=1, kernel='linear'),
           svm.SVC(C=1, kernel='linear', class_weight={-1: 1, 1: 10}), # 类别为-1的权重是1，类别是1的权重是10
           svm.SVC(C=0.8, kernel='rbf', gamma=0.5, class_weight={-1: 1, 1: 2}),# 类别为-1的权重是1，类别是1的权重是2
           svm.SVC(C=0.8, kernel='rbf', gamma=0.5, class_weight={-1: 1, 1: 10})]# 类别为-1的权重是1，类别是1的权重是10
